...
\begin{frame}{Kernfusion zur Energiegewinning}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{PlasmaImMagnetfeld.png}
    \end{figure}
\end{frame}
    ...
    \begin{frame}{Tokamak-Architektur}
        \begin{figure}
            \centering
            \includegraphics[width=0.6\textwidth]{Tokamak.png}
        \end{figure}    
    \end{frame}
    ...
    \begin{frame}{Stellarator-Architektur}
        \begin{figure}
            \centering
            \includegraphics[width=0.9\textwidth]{Stellarator.png}
        \end{figure}    
    \end{frame}
...
\begin{frame}{Energieumwandlung im Blanket}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.9\textwidth]{Blanket.png}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
